...
# read three month anomaly, here 202001,02,03 .nc and plot
# https://twitter.com/bramasolo/status/1300056902072561664
g2 <- gplotx(zt, "anom", returnx=TRUE, minz=-7.5, maxz=7.5, fillopts=NA, legend_label="2020-03 Anomaly  ", legend_pos=c(0.65, 0.09), maxlim=180)
g1 <- gplotx(anom, "anom", returnx=TRUE, minz=-7.5, maxz=7.5, fillopts=NA, legend_label="2020-02 Anomaly  ", legend_pos=c(0.65, 0.09), maxlim=180)
gx1 <- gplotx(tt1, "anom", returnx=TRUE, minz=-7.5, maxz=7.5, fillopts=NA, legend_label="2020-01 Anomaly  ", legend_pos=c(0.65, 0.09), maxlim=180)
grid.arrange(gx1, g1, g2,  layout_matrix=layt)
