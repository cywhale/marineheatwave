...
yrng <- seq(1982,2023) #1982, 2022 #example here only evaluate duration at 2022 #current dataset includes 198109 - 202206 (update 202206)
curryr <- year(Sys.Date())
currmo <- month(Sys.Date())
startm <- 1 #1 #normally we evaluate 1-12 month. But here we only test 2 month: Apr, May, 2022
